 ...
 */
public class Data {
    public static String[] MAIN_TITLE={"状态显示页面","常见ListView显示","常见分组ListView显示","常见GridView显示","多布局Listview显示","Tab+Fragment快速实现","LIST视频播放"};
    public static String[] MAIN_INFO={"显示加载中,无数据,加载错误,以及数据页\n让耗时的过程有个过度,增高用户体验\n本页为方便演示,具体使用看下面例子","数据加载页,无数据页,网络错误页\n包含下拉刷新,自动加载,图片显示及缓存\n本页菜单可切换下拉刷新",
            "数据加载页,无数据页,网络错误页\n包含下拉刷新,自动加载,图片显示及缓存\n本页菜单可切换加载动画",
            "常见GridView显示\n包含下拉刷新,自动加载,图片显示及缓存\n数据加载页,无数据页,网络错误页",
            "多布局ListView显示\n同一个ListView里面不同Item根据需求使用不同布局\n高效,简便",
            "Tab+Fragment快速实现\nTab动画效果,ViewPagerg管理\n可根据XML的属性设置自己想要的风格",
            "LIST视频播放\n模仿QQ空间,秒拍等播放模式\n播放UI可自定义,拓展性强"};
    public static String[] MAIN_IMAGE_URL={"https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3229897698,2043497950&fm=21&gp=0.jpg","http://e.hiphotos.baidu.com/zhidao/wh%3D450%2C600/sign=9b8f4fa4da33c895a62b907fe4235fc6/0823dd54564e925845a2bedd9f82d158ccbf4e6a.jpg",
    ...
    "http://v1.qzone.cc/avatar/201403/23/11/54/532e5aefc546e496.jpg!200x200.jpg"};
